...
pub async fn get_value(data: web::Data<AppState>, web::Path(key): web::Path<String>,) -> impl Responder {
...
pub async fn update_value(data: web::Data<AppState>, web::Path(key): web::Path<String>, value: String) -> impl Responder {
...
pub async fn delete_value(data: web::Data<AppState>, web::Path(key): web::Path<String>) -> impl Responder {
